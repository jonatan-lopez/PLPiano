namespace CannedBytes.Midi.Samples.MidiMapper.UI
{
    partial class MapItemForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.NoteInNumberCtrl = new CannedBytes.Midi.Samples.MidiMapper.UI.NoteNumberControl();
            this.NoteOutNumberCtrl = new CannedBytes.Midi.Samples.MidiMapper.UI.NoteNumberControl();
