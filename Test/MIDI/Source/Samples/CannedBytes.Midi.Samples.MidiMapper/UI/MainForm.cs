...
namespace CannedBytes.Midi.Samples.MidiMapper.UI
{
    partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            if (MidiInList.Items.Count > 0)
            {
                MidiInList.SelectedIndex = 0;
            }

            if (MidiOutList.Items.Count > 0)
            {
                if (MidiInList.Items.Count > 0)
                {
                    MidiOutList.Text = MidiInList.Text;
                }
                else
                {
            ...
            ListenChannel.SelectedIndex = 0;
            SendChannel.SelectedIndex = 0;
        ...
        private void FillMidiPortLists()
        {
            ...
            {
                MidiInList.Items.Add(inCaps.Name);
            }

            foreach (MidiOutPortCaps outCaps in new MidiOutPortCapsCollection())
            {
                MidiOutList.Items.Add(outCaps.Name);
            }
        }
